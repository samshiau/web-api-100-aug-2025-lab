...
1. We need an endpoint that we can GET that returns all the shows. This should be a `/api/shows`. This should return a list (array) of the same model returned from the `POST /api/shows`.
